...
void keyPressed()
{
   ...
   if(key=='p')//this will pause the game when you press 'p'
  {
    ...
    text("Game is Paused",280,60);
    text("Press 'l' key to resume the game",280,90);
    fill(255);
    textSize(18);
    text("(1).You use the arrow keys to make the spaceship move",280, 140);   
    text("(2).if you press the 's' key, it will shoot a bullet",280,185);
    text("(3).if you interact with the black alien, you lose a life",280,250);
    text("(4).if you interact with the red alien, you gain a point",280,305);
    text("(5).if you interact with the blue alien, you gain a life",280,370);
    text("(6).if you get a green alien, it gives a power,",280,425);
    text("if you get six it will slow down the aliens",280,455);
